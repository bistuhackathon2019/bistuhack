...
<%
    ...
    rootPath = "E:\\bistugame\\prdictimg\\";
    //取得客户端上传的数据类型
    ...
    try {
        if (contentType.indexOf("multipart/form-data") >= 0) {
            ...
            pr = Runtime.getRuntime().exec("C:\\Users\\hyy\\Anaconda3\\envs\\yolo\\python.exe E:\\faceRecognition\\main.py");
			
           BufferedReader ins = new BufferedReader(new InputStreamReader(pr.getInputStream()));
            String liness = null;
            while ((liness = ins.readLine()) != null) {
                out.println(liness);
